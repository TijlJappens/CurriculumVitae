...
\EducationEntry{PhD}{2019-current}{KU Leuven}{At the institute for theoretical physics. On topological phases of quantum matter. I have two manuscripts (\cite{bachmann2022classification} and \cite{jappens2023spt}) under review in communications in mathematical physics and both are set to be published shortly. A third manuscript is underway.}
