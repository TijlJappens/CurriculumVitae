...
\EducationEntry{PhD}{2019-current}{KU Leuven}{At the institute for theoretical physics. On topological phases of quantum matter. I have two manuscripts. \cite{jappens2023spt} has been accepted for publication and \cite{bachmann2022classification} is still under review (but is close to being accepted). Both have been sent to the journal communications in mathematical physics. A third manuscript is underway.}
...
\SkillsEntry{Mathematics}{Algebra (groups, Von Neumann algebras, representation theory (for both groups and algebras)), Algebraic topology (like homology, cohomology, homotopy groups ect.), (functional) Analyses}
